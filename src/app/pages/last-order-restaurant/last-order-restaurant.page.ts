...
@Component({
  selector: 'app-last-order-restaurant',
  templateUrl: './last-order-restaurant.page.html',
  styleUrls: ['./last-order-restaurant.page.scss'],
  standalone: true,
...
export class LastOrderRestaurantPage implements OnInit {
